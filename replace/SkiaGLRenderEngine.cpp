    ...
    namespace renderengine
    {
        namespace skia
        {
            ...
            bool SkiaGLRenderEngine::useProtectedContextImpl(GrProtected isProtected)
            {
                ...
                const EGLContext context = (isProtected == GrProtected::kYes) ? mProtectedEGLContext : mEGLContext;
            ...
            // write pixelate() function
            // goal to render 1 block per 5 x 5 original pixels

            // THIS HERE PIXEL CODE
